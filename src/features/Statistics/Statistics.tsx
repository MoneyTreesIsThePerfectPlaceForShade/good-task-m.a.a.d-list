...
import { procentConverter } from "../handlers/procentConverter";
...
export const Statistics = () => {
  ...
  return (
    <div className={styles.container}>
      <div>
        <button onClick={toggleNumbersPercents} className={styles.toggler}>
          {(openNumbers && "Проценты") || (openPercents && "Числа")}
        </button>
      </div>
